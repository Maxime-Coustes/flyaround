...
class Reservation
{
     ...
     * Add passengers
     *
     * @param \CoavBundle\Entity\User $passengers
     * @return Reservation
     */
    public function addPassenger(\CoavBundle\Entity\User $passengers)
    {
     ...
     * @param \CoavBundle\Entity\User $passengers
     */
    public function removePassenger(\CoavBundle\Entity\User $passengers)
    {
     ...
     * @return Reservation
     */
    public function setDeparture(\CoavBundle\Entity\Flight $departure = null)
    {
